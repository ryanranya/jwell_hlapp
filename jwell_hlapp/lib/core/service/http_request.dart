...
import 'package:jwell_hlapp/core/service/config.dart';
...
//  post 请求
  static Future<T> postRequest<T>(String url,
      {Map<String, dynamic> params, Interceptor inter}) async {
    //    1、创建单独配置 application/x-www-form-urlencoded 格式编码
    final options = Options(method: "post",contentType: Headers.formUrlEncodedContentType);
